...
if page == "Dashboard":
    ...
    doc_tabs = st.tabs(["Project Overview", "Augment Guidelines", "Technical Details"])
    ...
    with doc_tabs[1]:
        # Read and display the Augment Guidelines
        try:
            with open(os.path.join(os.path.dirname(__file__), "AUGMENT_GUIDELINES.md"), "r") as f:
